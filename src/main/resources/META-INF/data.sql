...
insert into books (id, title, isbn, author, year, description) values (-1, 'A1', '1', 'aaaaaa', 2016, 'qqqqq')
insert into books (id, title, isbn, author, year, description) values (-2, 'A2', '2', 'ssssss', 2017, 'rrrrr')
insert into books (id, title, isbn, author, year, description) values (-3, 'A3', '3', 'rrrrrr', 2018, 'ttttt')